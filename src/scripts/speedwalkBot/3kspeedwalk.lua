...
speedwalkBot.paths["tochess"] = {"enter", "1e","climb pipe"}
...
speedwalkBot.paths["tohotel"] = {"enter", "3e 2s 2e s 2w","buy hotel transylvania", "theatre", "e", "enter", "pull rug", "dispose ticket"}
...
speedwalkBot.paths["todftree"] = {"enter", "3w n", "enter"}
...
speedwalkBot.paths["tomj"] = {"enter", "2w 2s", "draw tile"}
